...
//统计图片引入
const iconUrl1 = new URL('@/assets/image/users.png', import.meta.url).href
const iconUrl2 = new URL('@/assets/image/like.png', import.meta.url).href
const iconUrl3 = new URL('@/assets/image/comments.png', import.meta.url).href
const iconUrl4 = new URL('@/assets/image/smile.png', import.meta.url).href
