            ...
            <!-- 情绪评分 -->
             ...
             <div class="diary-card">
                ...
                <div class="emotion-grid">
                    <div v-for="emotion in emotionptions" :key="emotion.name" class="emotion-card" :class="{'selected':emotion.name === diaryForm.dominantEmotion}" @click="selectedEmotion(emotion.name)">
...
const iconUrl = new URL('@/assets/image/like.png', import.meta.url).href
const emotionStatus = ['绝望崩溃', '消沉抑郁', '焦虑烦躁', '低落不悦', '平静淡然', '轻松惬意', '愉悦舒心', '欢欣满足', '兴奋欣喜', '极致幸福']

const emotionptions=[
{ name:'开心', url: new URL('@/assets/image/开心.png', import.meta.url).href },
{ name:"平静",url: new URL('@/assets/image/平静.png', import.meta.url).href },
{ name:'焦虑', url: new URL('@/assets/image/焦虑.png',import.meta.url).href },
{ name:'悲伤', url: new URL('@/assets/image/悲伤.png', import.meta.url).href },
{ name:'兴奋',url: new URL('@/assets/image/兴奋.png', import.meta.url).href },
{ name:'疲惫',url: new URL('@/assets/image/疲惫.png',import.meta.url).href },
{ name:'惊讶', url: new URL('@/assets/image/惊讶.png',import.meta.url).href },
{ name: '困惑', url: new URL('@/assets/image/困惑.png', import.meta.url).href },
]
