<template>
 ...
 <el-descriptions :column="2" border>
          <el-descriptions-item label="主要情绪">
            <el-tag :type="getAiEmotionTagType(aiData.dominantEmotion)">{{aiData.dominantEmotion}}</el-tag>
          </el-descriptions-item>
          <el-descriptions-item label="情绪强度">
            <el-tag :percentage="aiData.emotionScore" :color="getEmotionScoreColor(aiData.emotionScore)" :stroke-width="8" />
          </el-descriptions-item>
...
const formItem =[
  ...
  {comp:'select',label:'情绪评分',prop:'moodScoreRange',placeholder:'请选择评分范围',options:[
