                    ...
                    <!-- 温暖建议卡片 -->
                     <div class="warm-suggestion" v-if="currentEmotion.suggestion">
                        ...
                        <!-- 治愈行动 -->
                         ...
                         <!-- 温馨提示 -->
                          <div class="risk-notice" v-if="currentEmotion.riskLevel&&currentEmotion.isNegative >1">
              ...
              <div v-for="msg in messages" :key="msg.id" class="message-item" :class="msg.senderType === 1 ? 'user-message' : 'ai-message'">
                ...
                <div class="message-content">
                    <div class="message-bubble">
                        ...
                        <!-- AI错误提示 -->
                         <div v-else-if="msg.isError" class="error-mseeage">
                            <p>{{ msg.content }}</p>
                         </div>
                        <!-- AI正常返回消息 -->
...
const iconUrl = new URL('@/assets/image/robot-fill.png', import.meta.url).href
const iconUrl1 = new URL('@/assets/image/like.png', import.meta.url).href
const iconUrl2 = new URL('@/assets/image/users.png', import.meta.url).href
...
const sendMessage = () => {
    ...
    if(isAiTyping.value){
        ElMessage.warning('AI助手正在输入中，请稍后再发送')
        return
    }
    ...
    fetchEventSource('/api/psychological-chat/stream',{
        ...
        onmessage:(event)=>{
            ...
            if(ok&&payload.data&&payload.data.content){
                ...
                //错误回复的显示
                handleError(payload.message||'AI助手返回错误的响应')
            }
